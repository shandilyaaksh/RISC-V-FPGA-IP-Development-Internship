...
Full wiring instructions, address-decode rules, and pin-constraint guidance: **[`docs/Integration_Guide.md`](/SPI_Master/docs/IP_User_Guide.md#6-known-limitations--notes)**
